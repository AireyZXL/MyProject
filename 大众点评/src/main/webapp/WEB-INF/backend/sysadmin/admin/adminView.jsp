				...
				<div class="content">
					<table id="myTable" border="0" width="80">
						<tr>
							...
							<td>头像:</td>
							<td>
								<img height="90px" width="90px" src="${app }/sysadmin/admin?imgurl=${adminMsg.info.imgurl}" alt=""></img>
							</td>
						</tr>
	
						<tr>
							<td>真实姓名:</td>
							<td>${adminMsg.info.name }</td>
							<td>身份证号码:</td>
							<td>${adminMsg.info.cardNo }</td>
						</tr>
	
						<tr>
							<td>性别:</td>
							<td>${adminMsg.info.gender }</td>
							<td>生日日期:</td>
							<td><fmt:formatDate value="${adminMsg.info.birthday}" pattern="yyyy-MM-dd"/></td>
						</tr>
	
						<tr>
							<td>电话号码:</td>
							<td>
								${adminMsg.info.telephone }
							</td>
							<td>邮箱:</td>
							<td>${adminMsg.info.email }</td>
						</tr>
						
						<tr>
							<td>备注信息:</td>
							<td colspan="3">
								<textarea name="info.remark" style="height:80px;width:100%" disabled="disabled">${adminMsg.info.remark }</textarea>
							</td>
						</tr>
					</table>
				</div>
